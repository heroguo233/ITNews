...
<div id="main">
    <div class="container">
        ...
        <div class="post-comment-form">
            ...
            <form method="post" action="${springMacroRequestContext.contextPath}/addComment">
            ...
            <div class="login-actions">
                <a class="btn btn-success" href="${springMacroRequestContext.contextPath}/?pop=1">登录后评论</a>
            </div>
            </#if>
        </div>
        ...
        <div id="comments" class="comments">
            ...
            <div class="media">
                <a class="media-left" href="${springMacroRequestContext.contextPath}/user/${commentvo.user.id!}">
    ...
    <script type="text/javascript" src="${springMacroRequestContext.contextPath}/scripts/main/site/detail.js"></script>
</div>
<#include "footer.ftl">
