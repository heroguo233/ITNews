<#include "header.ftl">
<link rel="stylesheet" href="${springMacroRequestContext.contextPath}/styles/detail.css">
<script type="text/javascript" async="" src="${springMacroRequestContext.contextPath}/scripts/za-0.1.1.min.js"></script>
<script src="${springMacroRequestContext.contextPath}/scripts/instant.e7a17de6.js"></script>
        ...
        $.ajax(
            {
                ...
                success:function(data){
                    ...
                    if (dataobj.code == '1') {
                        ...
                        alert("发送成功！")
                        window.location.href = '${springMacroRequestContext.contextPath}/msg/list';
                    }
                },
                fail:function () {
                    alert('出现错误，请重试');
